...
class GradABM():
    ...
    def init_state_tensors(self, learnable_params):
        ...
        # 根据当前的stage来修改infected_time，和下一状态改变的时间，注意下一状态改变时间目前由两个默认参数决定，但说是可以trainable的
    ...
    def step(self, t, param_t):
        ...
        # print(param_t) # 3.9910, 0.0100, 0.5563
        # input()
        learnable_params = {}
        if self.params['disease']=='COVID':
        ...
        if t==0:
            ...
            # print(self.agents_next_stage_times)
            ...
            # print(sum(self.agents_next_stage_times == self.agents_next_stage_times))
            # input()
